            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => {
                  ...
                  alert('Fitur download resi akan segera tersedia');
                }}
          ...
          {(!payment || payment.payment_status !== 'paid') && (
            <div className="bg-gradient-to-br from-red-600 via-red-500 to-orange-500 rounded-2xl p-6 text-white relative overflow-hidden">
              ...
              <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-1">
                      {isPending ? 'Lanjutkan Pembayaran' : 'Selesaikan Pembayaran'}
                    </h3>
                ...
                <button
                  onClick={() => router.push(`/customer/payment/${shipment.id}`)}
                  className="bg-white text-red-600 font-bold px-8 py-3 rounded-xl hover:bg-gray-100 transition-colors shadow-xl whitespace-nowrap"
                >
                  Bayar Sekarang
                </button>
              </div>
            ...
            <div className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-2xl p-6 text-white relative overflow-hidden">
              ...
              <div className="relative flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">
                    Paket Anda akan segera diproses dan dikirim
                  </p>
                </div>
              </div>
            </div>
